...
Tab11_Download_Code_UI <- function(id) {
    ...
    fluidRow(box(
        ...
        sidebar = boxSidebar(
            id="Tab11_Log_Options", width = 25, background = "#599740",
            ...
            awesomeCheckboxGroup(
                ...
                selected = c(
                    "box-sidebar-input", "shiny.selectInput",
                    "shiny.numberInput", "shiny.fileInputBinding",
                    "shiny.sliderInput", "shiny.checkboxInput",
                    "shiny.textInput", "shinyWidgets.awesomeRadio"
                )
            ),
            tags$hr(),
            awesomeRadio(
