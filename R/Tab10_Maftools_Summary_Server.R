...
Tab10_MAF_Text_Summary_Server <- function(id, datalist, rowselect) {
    moduleServer(id, function(input, output, session) {
        ...
        dataInputMAFPLOT <- metaReactive2({
            if (is.null(datalist[["MAF_manual_data"]]()) & is.null(rowselect())) {
                validate(need(!is.null(datalist[["MAF_manual_data"]]()) | !is.null(rowselect()),
                              "Please select cBioPortal dataset or upload your own mutation data."))
            } else if (!is.null(datalist[["MAF_manual_data"]]()) & is.null(rowselect())) {
                if (is.null(datalist[["patient_manual_data"]]()) & is.null(datalist[["sample_manual_data"]]())) {
                    metaExpr({ read.maf(maf = ..(datalist[["MAF_Val"]]())) })
                } else {
                    metaExpr({
                        Data_Clin <- ..(datalist[["Combined_clin"]]()) %>% mutate(Tumor_Sample_Barcode = PATIENT_ID)
                        read.maf(maf = ..(datalist[["MAF_Val"]]()), clinicalData = Data_Clin)
                    })
                }
            } else if (is.null(datalist[["MAF_manual_data"]]()) & !is.null(rowselect())) {
                metaExpr({
...
Tab10_MAF_Plot_Summary_Server <- function(id, datalist, rowselect) {
    moduleServer(id, function(input, output, session) {
        ...
        output$Tab10_Download_Summary_Plot_PNG <- downloadHandler(
            filename = function() { paste("MAF_Summary_Plot", '.png', sep = '') },
        ...
        output$Tab10_Download_Summary_Plot_SVG <- downloadHandler(
            filename = function() { paste("MAF_Summary_Plot", '.svg', sep = '') },
            content = function(file) {
                svg(
                    file,
                    width = input$Tab10_Summary_Plot_Width,
        ...
        output$Tab10_Download_Oncoplot_Plot_PNG <- downloadHandler(
            filename = function() { paste("Oncoplot", '.png', sep = '') },
            content = function(file) {
                png(
                    file,
        ...
        output$Tab10_Download_Oncoplot_Plot_SVG <- downloadHandler(
            filename = function() { paste("Oncoplot", '.svg', sep = '') },
            content = function(file) {
                svg(
                    file,
                    width = input$Tab10_Oncoplot_Plot_Width,
        ...
        observe({
            vchoices1 <- c(unique(datalist[["MAF_Val"]]()[,input$Tab10_Lollipop_Gene_Name_Column]), "None Selected")
        ...
        OncoStrip <-  metaReactive2({
            ...
            if (input$Tab10_Oncostrip_Select_Gene_1 != "None Selected" &
                ...
                metaExpr({
                    oncostrip(
                        ..(dataInputMAFPLOT()),
                        genes = c(..(input$Tab10_Oncostrip_Select_Gene_1), ..(input$Tab10_Oncostrip_Select_Gene_2))
                    )
                })
        ...
        output$Tab10_Download_Oncostrip_Plot_PNG <- downloadHandler(
            filename = function() { paste("Oncostrip", '.png', sep = '') },
            content = function(file) {
                png(
                    file,
        ...
        output$Tab10_Download_Oncostrip_Plot_SVG <- downloadHandler(
            filename = function() { paste("Oncostrip", '.svg', sep = '') },
            content = function(file) {
                svg(
                    file,
                    width = input$Tab10_Oncostrip_Plot_Width,
        ...
        output$Tab10_Download_TT_Plot_PNG <- downloadHandler(
            ...
            content = function(file) {
                ...
                laml.Tab10_Summary_Plot_Fraction = Tab10_Summary_Plot_Fraction(
                    maf = dataInputMAFPLOT(),
                    plot = input$Tab10_TT_Plot_Fraction,
                    useSyn = input$Tab10_TT_Include_Synonymous_Variants
                )
        ...
        # Lollipop plot
        observe({
            vchoiceslol <- unique(datalist[["MAF_Val"]]()[,input$Tab10_Lollipop_Gene_Name_Column])
        ...
        # Download
        output$Tab10_Download_Lollipop_Plot_1_PNG <- downloadHandler(
            filename = function() {
        ...
        output$Tab10_Download_Lollipop_Plot_1_SVG <- downloadHandler(
            filename = function() {
        ...
        # Download
        output$Tab10_Download_Lollipop_Plot_2_PNG <- downloadHandler(
            filename = function() {
        ...
        output$Tab10_Download_Lollipop_Plot_2_SVG <- downloadHandler(
            filename = function() {
        ...
        # Download
        output$Tab10_Download_Lollipop_Plot_3_PNG <- downloadHandler(
            filename = function() {
        ...
        output$Tab10_Download_Lollipop_Plot_3_SVG <- downloadHandler(
            filename = function() {
        ...
        # Download
        output$Tab10_Download_Mutation_Load_Plot_PNG <- downloadHandler(
            filename = function() {
        ...
        output$Tab10_Download_Mutation_Load_Plot_SVG <- downloadHandler(
            filename = function() {
