...
Tab10_MAF_Text_Summary_UI  <- function(id) {
    ns <- NS(id)
    tabBox(height = "500px", width = 12,
           tabPanel("MAF Summary", width = 12, status = "primary", solidHeader = TRUE,
                    h5(strong("Basic summary of inputted Mutation/MAF file:")),
                    shinycssloaders::withSpinner(verbatimTextOutput(ns("MAF1")))),
           tabPanel("Sample Summary", width = 12, status = "primary", solidHeader = TRUE,
                    h5(strong("Basic sample summary of inputted Mutation/MAF file:")),
                    shinycssloaders::withSpinner(verbatimTextOutput(ns("MAF2")))),
           tabPanel("Gene Summary", width = 12, status = "primary", solidHeader = TRUE,
                    h5(strong("Basic gene summary of inputted Mutation/MAF file:")),
                    shinycssloaders::withSpinner(verbatimTextOutput(ns("MAF3")))),
           tabPanel("All Fields Summary", width = 12, status = "primary", solidHeader = TRUE,
                    h5(strong("All fields in Mutation/MAF file:")),
                    shinycssloaders::withSpinner(verbatimTextOutput(ns("MAF4")))),
           tabPanel("Clinical Data", width = 12, status = "primary", solidHeader = TRUE,
                    h5(strong("Clinical data associated with samples:")),
    ...
    fluidRow(tabBox(width = 12, height = "1900px",
                    ...
                    tabPanel("MafSummary",
                             box(collapsible = T, title=("MafSummary Plots"), height = "800px",
                                 ...
                                 sidebar = boxSidebar(
                                     id="Tab10_MAF_Summary_Sidebar", width = 25, background = "#599740",
                                     icon = shiny::icon("rectangle-list"), h5(strong("Options:")),
                                     prettyToggle(inputId = ns("Tab10_Summary_Remove_Outlier"),
                                                  label_on = "Remove Outliers", label_off = "Remove Outliers",
                                     ...
                                     selectInput(inputId = ns("Tab10_Summary_Add_Stat"),
                                                 label = "Add Stat:", choices = c("mean", "median"), selected = ""
                                     ),
                                     sliderInput(inputId = ns("Tab10_Summary_Display_Top_Genes"),
                                                 label = "Display Top Genes:", value = 10, min = 0, max = 20
                                     ),
                                     tags$hr(),
                                     numericInput(ns("Tab10_Summary_Plot_Width"),
                                                  "Plot Width (inches):", value = 8, min = 1, max = 50
                                     ),
                                     numericInput(ns("Tab10_Summary_Plot_Height"),
                                                  "Plot Height (inches):", value = 5, min = 1, max = 50
                                     ),
                                     tags$hr(),
                                     downloadButton(ns('Tab10_Download_Summary_Plot_PNG'),
                                                    'Download Plot (PNG)', style = "width:100%;"), br(), br(),
                                     downloadButton(ns('Tab10_Download_Summary_Plot_SVG'),
                    ...
                    tabPanel("OncoPlot/OncoStrip",
                             ...
                             box(collapsible = T, title = "Oncostrip Of Selected Genes",
                                 ...
                                 sidebar = boxSidebar(
                                     id = "Tab10_Oncostrip_Sidebar", width = 25,
                                     background = "#599740", icon = shiny::icon("rectangle-list"),
                                     h5(strong("Options:")),
                                     selectInput(ns("Tab10_Oncostrip_Select_Gene_1"),
                                                 "Gene of Interest 1:", choices = ""
                                     ),
                                     selectInput(ns("Tab10_Oncostrip_Select_Gene_2"),
                                                 "Gene of Interest 2:", choices = ""
                                     ),
                                     selectInput(ns("Tab10_Oncostrip_Select_Gene_3"),
                             ...
                             box(collapsible = T, title = "Transition and Transversions",
                                 ...
                                 sidebar = boxSidebar(
                                     id = "Tab10_TT_Sidebar", width = 25, background = "#599740",
                                     icon = shiny::icon("rectangle-list"), h5(strong("Options:")),
                                     prettyToggle(
                    ...
                    tabPanel("Lollipop Plots",
                             fluidRow(
                                 box(collapsible = T, title = ("Choose Genes to Analyse"),
                                     ...
                                     column(3, numericInput(inputId = ns("Tab10_Lollipop_Gene_Name_Column"),
                                                            label = "Gene Name Column:", value = 1, min = 1)),
                                     column(3, selectInput(ns("Tab10_Lollipop_Select_Gene_1"),
                                                           "Gene of Interest 1:", choices = "")),
                                     column(3, selectInput(ns("Tab10_Lollipop_Select_Gene_2"),
                                                           "Gene of Interest 2:", choices = "")),
                                 ...
                                 box(collapsible = T, title = "Lollipop Plot 1", width = 12,
                                     ...
                                     sidebar = boxSidebar(id = "Tab10_Lollipop_Plot1_Sidebar",
                                                          ...
                                                          h5(strong("Options:")),
                                                          selectInput(ns("Tab10_Lollipop_Position_Label_1"),
                                                                      "Positions to Label:", choices = c("all", "None"), selected = "None"),
                                                          sliderInput(ns("Tab10_Lollipop_Label_Size_1"),
                                                                      "Label Size:", value = 0.9, min = 0, max = 2, step = 0.1),
                                                          sliderInput(ns("Tab10_Lollipop_Label_Angle_1"),
                                                                      "Label Angle:", value = 0, min = 0, max = 90), tags$hr(),
                                                          prettyToggle(inputId = ns("Tab10_Lollipop_Show_Mutation_Rate_1"),
                                                          ...
                                                          tags$hr(), numericInput(ns("Tab10_Lollipop_Plot_Width_1"),
                                                                                  "Plot Width (inches):", value = 8, min = 1, max = 50),
                                                          numericInput(ns("Tab10_Lollipop_Plot_Height_1"),
                                                                       "Plot Height (inches):", value = 5, min = 1, max = 50), tags$hr(),
                                                          downloadButton(ns('Tab10_Download_Lollipop_Plot_1_PNG'),
                                                                         'Download Plot (PNG)', style = "width:100%;"),  br(), br(),
                                                          downloadButton(ns('Tab10_Download_Lollipop_Plot_1_SVG'),
                                                                         'Download Plot (SVG)', style = "width:100%;")
                                     )
                                 ),
                                 ...
                                 box(collapsible = T, title = "Lollipop Plot 2", width = 12,
                                     ...
                                     sidebar = boxSidebar(id = "Tab10_Lollipop_Plot2_Sidebar",
                                                          width = 25, background = "#599740", icon = shiny::icon("rectangle-list"),
                                                          h5(strong("Options:")),
                                                          selectInput(ns("Tab10_Lollipop_Position_Label_2"),
                                                                      "Positions to Label:", choices = c("all", "None"), selected = "None"),
                                                          sliderInput(ns("Tab10_Lollipop_Label_Size_2"),
                                                                      "Label Size:", value = 0.9, min = 0, max = 2, step = 0.1),
                                                          sliderInput(ns("Tab10_Lollipop_Label_Angle_2"),
                                                                      "Label Angle:", value = 0, min = 0, max = 90), tags$hr(),
                                                          prettyToggle(inputId = ns("Tab10_Lollipop_Show_Mutation_Rate_2"),
                                                                       label_on = "Show Somatic Mutation Rate",
                                                                       label_off = "Show Somatic Mutation Rate",
                                                                       icon_on = fa_i(name = "check", verify_fa = FALSE),
                                                                       icon_off = fa_i(name = "times", verify_fa = FALSE), value = T),
                                                          ...
                                                          tags$hr(), numericInput(ns("Tab10_Lollipop_Plot_Width_2"),
                                                                                  "Plot Width (inches):", value = 8, min = 1, max = 50),
                                                          numericInput(ns("Tab10_Lollipop_Plot_Height_2"),
                                                                       "Plot Height (inches):", value = 5, min = 1, max = 50), tags$hr(),
                                                          downloadButton(ns('Tab10_Download_Lollipop_Plot_2_PNG'),
                                                                         'Download Plot (PNG)', style = "width:100%;"),  br(), br(),
                                                          downloadButton(ns('Tab10_Download_Lollipop_Plot_2_SVG'),
                                                                         'Download Plot (SVG)', style = "width:100%;")
                                     )
                                 ),
                                 ...
                                 box(collapsible = T, title = "Lollipop Plot 3", width = 12,
                                     ...
                                     sidebar = boxSidebar(id = "Tab10_Lollipop_Plot3_Sidebar",
                                                          width = 25, background = "#599740", icon = shiny::icon("rectangle-list"),
                                                          h5(strong("Options:")),
                                                          selectInput(ns("Tab10_Lollipop_Position_Label_3"),
                                                                      "Positions to Label:", choices = c("all", "None"), selected = "None"),
                                                          sliderInput(ns("Tab10_Lollipop_Label_Size_3"),
                                                                      "Label Size:", value = 0.9, min = 0, max = 2, step = 0.1),
                                                          sliderInput(ns("Tab10_Lollipop_Label_Angle_3"),
                                                                      "Label Angle:", value = 0, min = 0, max = 90), tags$hr(),
                                                          prettyToggle(inputId = ns("Tab10_Lollipop_Show_Mutation_Rate_3"),
                                                                       label_on = "Show Somatic Mutation Rate",
                                                                       label_off = "Show Somatic Mutation Rate",
                                                                       icon_on = fa_i(name = "check", verify_fa = FALSE),
                                                                       icon_off = fa_i(name = "times", verify_fa = FALSE), value = T),
                                                          ...
                                                          tags$hr(), numericInput(ns("Tab10_Lollipop_Plot_Width_3"),
                                                                                  "Plot Width (inches):", value = 8, min = 1, max = 50),
                                                          numericInput(ns("Tab10_Lollipop_Plot_Height_3"),
                                                                       "Plot Height (inches):", value = 5, min = 1, max = 50), tags$hr(),
                                                          downloadButton(ns('Tab10_Download_Lollipop_Plot_3_PNG'),
                                                                         'Download Plot (PNG)', style = "width:100%;"),  br(), br(),
                                                          downloadButton(ns('Tab10_Download_Lollipop_Plot_3_SVG'),
                                                                         'Download Plot (SVG)', style = "width:100%;")
                                     )
                                 )
                             )
                    ...
                    tabPanel("Other Plots", id = "tabsetMAFother",
                             box(dropdownMenu = boxDropdown(icon = fa_i(name = "info-circle", verify_fa = FALSE),
                                                            boxDropdownItem(
                                                                HTML(paste("Useful Resources for maftools:", "<br/>")),
                                                                tags$a(
                                                                    href = "https://www.bioconductor.org/packages/devel/bioc/vignettes/maftools/inst/doc/maftools.html",
                             ...
                             sidebar = boxSidebar(id = "Tab10_Mutation_Load_Sidebar", width = 25, background = "#599740",
                                                  ...
                                                  h5(strong("Options:")),
                                                  numericInput(ns("Tab10_Mutation_Load_Plot_Width"),
                                                               "Plot Width (inches):", value = 8, min = 1, max = 50
                                                  ),
                                                  numericInput(ns("Tab10_Mutation_Load_Plot_Height"),
                                                               "Plot Height (inches):", value = 5, min = 1, max = 50
                                                  ), tags$hr(),
                                                  downloadButton(ns('Tab10_Download_Mutation_Load_Plot_PNG'),
                                                                 'Download Plot (PNG)', style = "width:100%;"
                                                  ),  br(), br(),
                                                  downloadButton(ns('Tab10_Download_Mutation_Load_Plot_SVG'),
                                                                 'Download Plot (SVG)', style = "width:100%;"
                                                  )
                             )
                             ),
                             box(collapsible = T, title = "Somatic Interaction Plot", width = 12, solidHeader = T, status = "primary",
                                 ...
                                 sidebar = boxSidebar(id = "Tab10_Somatic_Interaction_Sidebar", width = 25, background = "#599740",
                                                      icon = shiny::icon("rectangle-list"),
                                                      h5(strong("Options:")),
                                                      sliderInput(ns("Tab10_SIP_Display_Top_Genes"), "Top Genes:",
                                                                  value = 25, min = 0, max = 100, step = 5
                                                      ),
                                                      sliderInput(ns("Tab10_SIP_Pval_Lower_Threshold"), "P-value Lower Threshold:",
                                                                  value = 0.01, min = 0, max = 0.5
                                                      ),
                                                      sliderInput(ns("Tab10_SIP_Pval_Upper_Threshold"), "P-value Upper Threshold:",
                                                                  value = 0.05, min = 0, max = 0.5
                                                      ), tags$hr(),
                                                      numericInput(ns("Tab10_SIP_Plot_Width"), "Plot Width (inches):",
                                                                   value = 8, min = 1, max = 50
                                                      ),
                                                      numericInput(ns("Tab10_SIP_Plot_Height"), "Plot Height (inches):",
                                                                   value = 5, min = 1, max = 50
                                                      ), tags$hr(),
                                                      downloadButton(ns('Tab10_Download_SIP_Plot_PNG'),
                                                                     'Download Plot (PNG)', style = "width:100%;"
                                                      ),  br(), br(),
                                                      downloadButton(ns('Tab10_Download_SIP_Plot_SVG'),
                                                                     'Download Plot (SVG)', style = "width:100%;"
                                                      )
                                 )
                             )
