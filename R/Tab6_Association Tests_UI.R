    ...
    box(collapsible = T, title = "Association Tests", solidHeader = T, status = "primary", width = 12,
        dropdownMenu = boxDropdown(icon = fa_i(name = "info-circle", verify_fa = FALSE), boxDropdownItem(
            ...
            sidebar = boxSidebar(id="Tab6_Association_Test_Sidebar", width = 25, background = "#599740",  icon = shiny::icon("rectangle-list"),
                                 selectInput(ns("Tab6_Select_Association_Test"), "Association Test:", c("Chi-squared test", "Fishers exact test", "Simulated Fishers exact test", "ANOVA test", "Kruskal-Wallis test", "Pairwise t-test", "Dunns test", "Compare groups"), width = "95%"), tags$hr(width = "93%"),
                                 conditionalPanel(condition = "input.Tab6_Select_Association_Test == 'Chi-squared test' | input.Tab6_Select_Association_Test == 'Fishers exact test' | input.Tab6_Select_Association_Test == 'Simulated Fishers exact test'",
                                                  ns = ns,
                                                  selectizeInput(ns("Tab6_Select_Categorical_Variable_1"), "Select Categorical Variable 1:", choices = "", width = "95%"),
                                                  selectizeInput(ns("Tab6_Select_Categorical_Variable_2"), "Select Categorical Variables 2:", choices = "", multiple = T, width = "95%")),
                                 conditionalPanel(condition = "input.Tab6_Select_Association_Test == 'ANOVA test' | input.Tab6_Select_Association_Test == 'Kruskal-Wallis test' | input.Tab6_Select_Association_Test == 'Pairwise t-test' | input.Tab6_Select_Association_Test == 'Dunns test'",
                                                  ns = ns,
                                                  selectizeInput(ns("Tab6_Select_Categorical_Variable_3"), "Select Categorical Variable:", choices = "", width = "95%"),
            ...
            conditionalPanel(condition = "input.Tab6_Select_Association_Test == 'Fishers exact test'", ns = ns, h4(strong("Fisher's Exact Test:")), verbatimTextOutput(ns("Cat3")), br(), h4(strong("Adjusted P-values:")), withSpinner(dataTableOutput(ns("Cat3Ad")))),
            conditionalPanel(condition = "input.Tab6_Select_Association_Test == 'Simulated Fishers exact test'",  ns = ns, h4(strong("Simulated Fisher's Exact Test:")), verbatimTextOutput(ns("Cat2")), br(), h4(strong("Adjusted P-values:")), withSpinner(dataTableOutput(ns("Cat2Ad")))),
            conditionalPanel(condition = "input.Tab6_Select_Association_Test == 'ANOVA test'", ns = ns,
                             h4(strong("ANOVA Assumptions:")), h5(strong("Parametric Test for Equal Variance 1:")), verbatimTextOutput(ns("ANOVAAss1")), h5(strong("Non-Parametric Test for Equal Variance 2:")), verbatimTextOutput(ns("ANOVAAss2")), h5(strong("Test for Normality:")), verbatimTextOutput(ns("ANOVAAss3")), # the null hypothesis for this test is that the population variances are equal
                             h4(strong("ANOVA Test:")), verbatimTextOutput(ns("ANOVA")), br(), h4(strong("Adjusted P-values:")), withSpinner(dataTableOutput(ns("ANOVAAd")))),
            conditionalPanel(condition = "input.Tab6_Select_Association_Test == 'Kruskal-Wallis test'", ns = ns,
