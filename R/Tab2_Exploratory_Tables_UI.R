...
Tab2_Exploaratory_Tables_Clin_UI <- function(id) {
    ...
    tabPanel("All Clinical Data",
             fluidRow(box(title = "Data Table - Clinical Data", collapsible = TRUE, width = 12,
                          ...
                          sidebar = boxSidebar(
                              id = "Tab2_Clin_Sidebar", width = 25,
                              h4(strong("Select Columns to Display")),
                              background = "#599740",
                              icon = shiny::icon("rectangle-list"),
                              selectizeInput(
                                  ns("Tab2_Column1_Variable"), "Select Column 1:",
                                  choices = "None Selected", width = "95%", selected = "None Selected"
                              ),
                              selectizeInput(
                                  ns("Tab2_Column2_Variable"), "Select Column 2:",
                                  choices = "None Selected", width = "95%", selected = "None Selected"
                              ),
                              selectizeInput(
                                  ns("Tab2_Column3_Variable"), "Select Column 3:",
                                  choices = "None Selected", width = "95%", selected = "None Selected"
                              ),
                              selectizeInput(
                                  ns("Tab2_Column4_Variable"), "Select Column 4:",
                                  choices = "None Selected", width = "95%", selected = "None Selected"
                              ),
                              selectizeInput(
                                  ns("Tab2_Column5_Variable"), "Select Column 5:",
                                  choices = "None Selected", width = "95%", selected = "None Selected"
                              )
                          )
             )
