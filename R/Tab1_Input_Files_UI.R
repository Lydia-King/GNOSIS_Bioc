...
Tab1_Input_Files_Manual_UI <- function(id) {
    ...
    tabPanel("Manual Upload",
             fluidRow(box(title = "Input Patient Data File",
                          width = 3, status = "primary", solidHeader = TRUE,
                          collapsible = TRUE,
                          fileInput(ns("Input_Patient_File"),
                                    "Choose File:", multiple = TRUE,
                                    accept = c("text/csv",
                          ...
                          tags$hr(),
                          textInput(inputId = ns("Tab1_Comment_1"),
                                    label = "Comment Character:", value = "#"),
                          numericInput(inputId = ns("Tab1_Clin_Skip_Lines"),
                                       label = "Number of Lines to Skip:", value = 0,
                                       min = 0, max = 10),
                          tags$hr(),
             ...
             box(collapsible = TRUE, title = "Input Sample Data File",
                 ...
                 tags$hr(),
                 textInput(inputId = ns("Tab1_Comment_2"),
                           label = "Comment Character:", value = "#"),
                 numericInput(inputId = ns("Tab1_Sample_Skip_Lines"),
                              label = "Number of Lines to Skip:", value = 0,
                              min = 0, max = 10),
                 tags$hr(),
                 h5(strong("Total Number of Clinical Variables:")),
             ...
             box(title = "Input CNA File", status = "primary",
                 ...
                 numericInput(inputId = ns("Tab1_CNA_Skip_Lines"),
             ...
             box(collapsible = TRUE, title = "Input MAF File",
                 ...
                 numericInput(inputId = ns("Tab1_MAF_Skip_Lines"), label = "Number of Lines to Skip:",
                              value = 0, min = 0, max = 10),
                 tags$hr(),
                 h5(strong("Total Number of Columns:")),
