    ...
    ns <- NS(id)
        box(title = "Histogram and Density Plots", width = 12, solidHeader = T, status = "primary", height = "570px", collapsible = T,
            sidebar = boxSidebar(width = 25, id = "Tab4_Density_Histogram_Sidebar", background = "#599740",  icon = shiny::icon("rectangle-list"),
                                 ...
                                 conditionalPanel(condition = ns("input.Tab4_Select_Plot_Type == 'Histogram'"), h5(strong("Options:")),
                                                  ...
                                                  conditionalPanel(condition = "input.Tab4_Select_Histogram_Type == 'Plain'", ns = ns , tags$hr(),
                                                                   ...
                                                                   tags$hr(), numericInput(ns("Tab4_Plot_Width"), "Plot Width (inches):", value=8, min=1, max=50),
                                                                   numericInput(ns("Tab4_Plot_Height"), "Plot Height (inches):", value=5, min=1, max=50), tags$hr(),
                                                                   downloadButton(ns('Tab4_Download_PNG'),'Download Plot (PNG)', style = "width:100%;"),
                                                                   br(), br(), downloadButton(ns('Tab4_Download_SVG'),'Download Plot (SVG)', style = "width:100%;")),
            ...
            conditionalPanel(condition = "input.Tab4_Select_Plot_Type == 'Histogram'", ns = ns , width = 12,
                             conditionalPanel(condition = "input.Tab4_Select_Histogram_Type == 'Plain'", ns = ns , width = 12, withSpinner(plotOutput(ns("Plot1"), height = "540px"))), # Plain Histogram Plot
                             conditionalPanel(condition = "input.Tab4_Select_Histogram_Type == 'Facet Wrap'", ns = ns, width = 12, withSpinner(plotOutput(ns("Plot"), height = "600px")))) # Faceted Histogram Plot
