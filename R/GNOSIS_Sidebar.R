    ...
    tagList(
        sidebarMenu(menuItem("Input Files", tabName = "input_files", icon = fa_i(name ="file-alt", verify_fa = FALSE),
                    ...
                    menuItem("Exploratory Plots", tabName = "plots", icon = fa_i(name ="chart-bar", verify_fa = FALSE),
                             ...
                             menuSubItem("Barplots", tabName = "barplot", icon = fa_i(name ="chart-bar", verify_fa = FALSE)),
                             menuSubItem("Histograms/Density Plots", tabName = "density_hist", icon = fa_i(name ="chart-area", verify_fa = FALSE))),
