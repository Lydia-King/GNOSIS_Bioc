...
Tab3_Factor_Levels_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
        ...
        Formatted_Data <- metaReactive2({
            metaExpr({
                ..(datalist[[data]]()) %>%
                    mutate_at(..(input$Tab3_Variables_to_Numeric), list(as.numeric)) %>%
                    mutate_at(..(input$Tab3_Variables_to_Factor), list(as.factor))
            })
        })
...
Tab3_Subset_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
        ...
        observe({
            ...
            updateSelectInput(session, "Tab3_Subset_Variable_1",
                              choices = vchoicesSub, selected = vchoicesSub[1])
            updateSelectInput(session, "Tab3_Subset_Variable_2",
                              choices = vchoicesSub, selected = vchoicesSub[1])
            updateSelectInput(session, "Tab3_Subset_Variable_3",
                              choices = vchoicesSub, selected = vchoicesSub[1])
        })

        observe({
            vchoicesSub1 <- c(levels(datalist[[data]]()[,input$Tab3_Subset_Variable_1]), "None Selected")
            updateSelectInput(session, "Tab3_Subset_Variable_Levels_1",
                              choices = vchoicesSub1, selected = "None Selected")
        })

        observe({
            vchoicesSub2 <- c(levels(datalist[[data]]()[,input$Tab3_Subset_Variable_2]), "None Selected")
            updateSelectInput(session, "Tab3_Subset_Variable_Levels_2",
                              choices = vchoicesSub2, selected = "None Selected")
        })

        observe({
            vchoicesSub3 <- c(levels(datalist[[data]]()[,input$Tab3_Subset_Variable_3]), "None Selected")
            updateSelectInput(session, "Tab3_Subset_Variable_Levels_3",
                              choices = vchoicesSub3, selected = "None Selected")
        })

        Clinical_Sub <- metaReactive2({
            validate(need(!is.null(input$Tab3_Subset_Variable_Levels_1) &
            ...
            if (isTRUE(input$Tab3_Subset_Variable_Levels_1 == "None Selected" &
                       input$Tab3_Subset_Variable_Levels_2 == "None Selected" &
                       input$Tab3_Subset_Variable_Levels_3 == "None Selected")) {
                metaExpr({..(datalist[[data]]()) })
            } else if (isTRUE("None Selected" %!in% c(input$Tab3_Subset_Variable_Levels_1) &
                              input$Tab3_Subset_Variable_Levels_2 == "None Selected" &
                              input$Tab3_Subset_Variable_Levels_3 == "None Selected")) {
                metaExpr({dat <- filter(..(datalist[[data]]()),
                                        ..(datalist[[data]]())[,..(input$Tab3_Subset_Variable_1)] %in% ..(input$Tab3_Subset_Variable_Levels_1))
                dat %>% mutate_at(c(..(input$Tab3_Subset_Variable_1)), list(as.character)) %>%
                    mutate_at(c(..(input$Tab3_Subset_Variable_1)), list(as.factor))
                })
            } else if (isTRUE(input$Tab3_Subset_Variable_Levels_1 == "None Selected" &
                ...
                dat %>% mutate_at(c(..(input$Tab3_Subset_Variable_2)), list(as.character)) %>%
                    mutate_at(c(..(input$Tab3_Subset_Variable_2)), list(as.factor))})
            } else if (isTRUE(input$Tab3_Subset_Variable_Levels_1 == "None Selected" &
                              input$Tab3_Subset_Variable_Levels_2 == "None Selected" &
                ...
                dat %>% mutate_at(c(..(input$Tab3_Subset_Variable_3)), list(as.character)) %>%
                    mutate_at(c(..(input$Tab3_Subset_Variable_3)), list(as.factor))})
            } else if (isTRUE("None Selected" %!in% c(input$Tab3_Subset_Variable_Levels_1) &
                              "None Selected" %!in% c(input$Tab3_Subset_Variable_Levels_2) &
                              input$Tab3_Subset_Variable_Levels_3 == "None Selected")) {
                metaExpr({dat <- filter(..(datalist[[data]]()),
                                        ..(datalist[[data]]())[,..(input$Tab3_Subset_Variable_1)] %in% ..(input$Tab3_Subset_Variable_Levels_1),
                                        ..(datalist[[data]]())[,..(input$Tab3_Subset_Variable_2)] %in% ..(input$Tab3_Subset_Variable_Levels_2))
                dat %>% mutate_at(c(..(input$Tab3_Subset_Variable_1), ..(input$Tab3_Subset_Variable_2)), list(as.character)) %>%
                    mutate_at(c(..(input$Tab3_Subset_Variable_1), ..(input$Tab3_Subset_Variable_2)), list(as.factor))
                })
            } else if (isTRUE("None Selected" %!in% c(input$Tab3_Subset_Variable_Levels_1) &
                              input$Tab3_Subset_Variable_Levels_2 == "None Selected" &
                              "None Selected" %!in% c(input$Tab3_Subset_Variable_Levels_3))) {
                metaExpr({dat <- filter(..(datalist[[data]]()),
                                        ..(datalist[[data]]())[,..(input$Tab3_Subset_Variable_1)] %in% ..(input$Tab3_Subset_Variable_Levels_1),
                                        ..(datalist[[data]]())[,..(input$Tab3_Subset_Variable_3)] %in% ..(input$Tab3_Subset_Variable_Levels_3))
                dat %>% mutate_at(c(..(input$Tab3_Subset_Variable_1), ..(input$Tab3_Subset_Variable_3)), list(as.character)) %>%
                    mutate_at(c(..(input$Tab3_Subset_Variable_1), ..(input$Tab3_Subset_Variable_3)), list(as.factor))
                })
            } else if (isTRUE(input$Tab3_Subset_Variable_Levels_1 == "None Selected" &
                              "None Selected" %!in% c(input$Tab3_Subset_Variable_Levels_2) &
                              "None Selected" %!in% c(input$Tab3_Subset_Variable_Levels_3))) {
                ...
                dat %>% mutate_at(c(..(input$Tab3_Subset_Variable_2), ..(input$Tab3_Subset_Variable_3)), list(as.character)) %>%
                    mutate_at(c(..(input$Tab3_Subset_Variable_2), ..(input$Tab3_Subset_Variable_3)), list(as.factor))})
            } else {
                validate(need("None Selected" %!in% c(input$Tab3_Subset_Variable_Levels_1) &
                                  "None Selected" %!in% c(input$Tab3_Subset_Variable_Levels_2) &
                                  "None Selected" %!in% c(input$Tab3_Subset_Variable_Levels_3),
                ...
                dat %>% mutate_at(c(..(input$Tab3_Subset_Variable_1), ..(input$Tab3_Subset_Variable_2), ..(input$Tab3_Subset_Variable_3)), list(as.character)) %>%
                    mutate_at(c(..(input$Tab3_Subset_Variable_1), ..(input$Tab3_Subset_Variable_2), ..(input$Tab3_Subset_Variable_3)), list(as.factor))
                })
                }
            })

        output$TableRecode1 = metaRender(renderDataTable, {
            datatable(..(Clinical_Sub()),
                      options = list(lengthMenu = c(10, 30, 50, 100),
                                     pageLength = 30, scrollX = TRUE, scrollY = "350px"))
        })

        output$TableLevels = metaRender(renderPrint, {
            sapply(..(Clinical_Sub())[,c(..(input$Tab3_Subset_Variable_1),
                                         ..(input$Tab3_Subset_Variable_2),
                                         ..(input$Tab3_Subset_Variable_3))], levels)
        })
...
Tab3_Recode_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
        observe({
            ...
            updateSelectInput(session, "Tab3_Select_OS_Column", choices = vchoicesRecode,
                              selected = "None Selected")
            updateSelectInput(session, "Tab3_Select_DSS_Column", choices = vchoicesRecode,
                              selected = "None Selected")
        })
        ...
        dataClinicalSurv <- metaReactive2({
            if (input$Tab3_Recode_Survival_Yes_or_No == "Yes" &
                ...
                metaExpr({..(datalist[[data]]())})
                       ...
                       input$Tab3_Select_DSS_Column == "None Selected") {
                metaExpr({..(datalist[[data]]()) %>%
                        mutate(OS = ifelse(..(datalist[[data]]())[,..(input$Tab3_Select_OS_Column)] ==
                                               ..(input$Tab3_OS_Event), 1, 0))})
            } else if (input$Tab3_Recode_Survival_Yes_or_No == "Yes" &
                       !is.null(datalist[[data]]()) &
                       input$Tab3_Select_OS_Column == "None Selected" &
                       input$Tab3_Select_DSS_Column != "None Selected") {
                metaExpr({ ..(datalist[[data]]()) %>%
                        mutate(DSS = ifelse(..(datalist[[data]]())[,..(input$Tab3_Select_DSS_Column)] ==
                                                ..(input$Tab3_DSS_Event), 1, 0)) })
            } else if (input$Tab3_Recode_Survival_Yes_or_No == "Yes" &
                       !is.null(datalist[[data]]()) &
                       input$Tab3_Select_OS_Column != "None Selected" &
                       input$Tab3_Select_DSS_Column != "None Selected") {
                metaExpr({..(datalist[[data]]()) %>%
                        mutate(OS = ifelse(..(datalist[[data]]())[,..(input$Tab3_Select_OS_Column)] ==
                                               ..(input$Tab3_OS_Event), 1, 0),
                               DSS = ifelse(..(datalist[[data]]())[,..(input$Tab3_Select_DSS_Column)] ==
                                                ..(input$Tab3_DSS_Event), 1, 0)) })
        ...
        TableRecode_Pre =  metaReactive2({
            if (input$Tab3_Recode_Survival_Yes_or_No == "No" |
                ...
                metaExpr({ ..(dataClinicalSurv())[,c(..(input$Tab3_Select_DSS_Column), "DSS")]})
                       ...
                       (input$Tab3_Select_OS_Column != "None Selected" &
                        input$Tab3_Select_DSS_Column != "None Selected")) {
                metaExpr({..(dataClinicalSurv())[,c(..(input$Tab3_Select_OS_Column),
                                                    ..(input$Tab3_Select_DSS_Column), "OS","DSS")]})
            }
        })

        output$TableRecode = metaRender(renderDataTable, {
            datatable(..(TableRecode_Pre()), options = list(lengthMenu = c(10, 30, 50, 100),
...
Tab3_CNACalc_Server <- function(id, datalist, datalist_Recode, data, rowselect) {
    moduleServer(id, function(input, output, session) {
        ...
        CNA_Clin <- metaReactive2({
            validate(need("PATIENT_ID" %in% colnames(datalist[["CNA_Val"]]()) |
            ...
            if (input$Tab3_CNA_of_Interest == "Single Gene") {
                ...
                if (sum(gene_list %in% datalist[["CNA_Val"]]()[,c("Hugo_Symbol")]) != length(gene_list)) {
                    ...
                    metaExpr({
                        ...
                        if (!is.null(datalist[["patient_manual_data"]]()) |
                            ...
                            !is.null(rowselect())) {
                            CNA_Status <- merge(..(datalist_Recode[[data]]()),
                                                CNA_Status,
                ...
                validate(need(is.numeric(datalist[["CNA_Val"]]()[,input$Tab3_CNA_Start_Column]),
                              "Please make sure CNA start column is numeric."))
                metaExpr({
                    PATIENT_ID <- colnames(..(datalist[["CNA_Val"]]())[,..(input$Tab3_CNA_Start_Column):ncol(..(datalist[["CNA_Val"]]()))])
                    Scores <- as.data.frame(PATIENT_ID)
                    Scores$CNA_Score <- colSums(abs(..(datalist[["CNA_Val"]]())[,..(input$Tab3_CNA_Start_Column):ncol(..(datalist[["CNA_Val"]]()))]),
                                                na.rm = ..(input$Tab3_CNA_Remove_NAs_Yes_or_No))
                    Scores <- na.omit(Scores)

                    Scores$Amp_Score <- na.omit(apply(X = ..(datalist[["CNA_Val"]]())[,..(input$Tab3_CNA_Start_Column):ncol(..(datalist[["CNA_Val"]]()))],
                                                      MARGIN = 2,
                                                      function(x) sum(x[x > 0], na.rm = ..(input$Tab3_CNA_Remove_NAs_Yes_or_No))))
                    Scores$Del_Score <- na.omit(apply(X = ..(datalist[["CNA_Val"]]())[,..(input$Tab3_CNA_Start_Column):ncol(..(datalist[["CNA_Val"]]()))],
                                                      MARGIN = 2,
                                                      function(x) sum(x[x < 0], na.rm = ..(input$Tab3_CNA_Remove_NAs_Yes_or_No))))
                    Scores$Del_Score <- abs(Scores$Del_Score)

                    if (..(input$Tab3_Segment_CNA_Yes_or_No) == "TRUE") {
                        Scores$Score_Quartile <-  fabricatr::split_quantile(x=Scores$CNA_Score,
                    ...
                    if (!is.null(datalist[["patient_manual_data"]]()) |
                        ...
                        CNA_Metrics_All <- merge(..(datalist_Recode[["recode_data"]]()),
                                                 CNA_Metrics,
                                                 by.x = input$Tab3_Merge_Column,
                                                 by.y = "PATIENT_ID")
                    } else {
                    ...
                    if (..(input$Tab3_Segment_CNA_Yes_or_No) == "TRUE") {
                        CNA_Metrics_All$Subset_Score_Quartile <-  fabricatr::split_quantile(x=CNA_Metrics_All$CNA_Score,
                                                                                type = ..(input$Tab3_Number_of_Segments))
                    }
        ...
        output$TableCNACalc = metaRender(renderDataTable, {
            datatable(..(CNA_Clin()), options = list(lengthMenu = c(10, 30, 50, 100),
                                                     pageLength = 30,
                                                     scrollX = TRUE,
                                                     scrollY = "400px"))
        })
    ...
    moduleServer(id, function(input, output, session) {
        ...
        output$TableData = metaRender(renderDataTable, {
            datatable(..(datalist[[data]]()),
                      options = list(lengthMenu = c(10, 30, 50, 100),
                                     pageLength = 30, scrollX = TRUE, scrollY = "400px"))
        })

        output$Tab3_Download_File = downloadHandler('Processed_Data.txt',
                                                    content = function(file) {
                                                        write.table(datalist[[data]](), file,
