...
Tab4_BoxPlots_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
        observe({
            ...
            updateSelectizeInput(session, "Tab4_Boxplot_Select_X_Variable",
                                 choices = vchoicesbox1, selected = "None Selected", server = TRUE)
            updateSelectizeInput(session, "Tab4_Boxplot_Select_Y_Variable",
                                 choices = vchoicesbox1, selected = "None Selected", server = TRUE)
        })
        ...
        boxplot <- metaReactive2({
            if(is.null(datalist[[data]]()) |
               ...
               input$Tab4_Boxplot_Select_Y_Variable == "None Selected") {
                ...
                metaExpr({
                    ggplot(data = ..(datalist[[data]]()),
                           mapping = aes(x = ..(datalist[[data]]())[,..(input$Tab4_Boxplot_Select_X_Variable)],
                                         y = ..(datalist[[data]]())[,..(input$Tab4_Boxplot_Select_Y_Variable)],
                                         color = ..(datalist[[data]]())[,..(input$Tab4_Boxplot_Select_X_Variable)])) +
                        geom_boxplot(varwidth = ..(input$Tab4_Boxplot_by_Sample_Size), na.rm = TRUE,
                                     aes(fill = ..(datalist[[data]]())[,..(input$Tab4_Boxplot_Select_X_Variable)]),
                                     alpha = 0.35) +
...
Tab4_Scatterplot_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
        ...
        observe({
            ...
            updateSelectizeInput(session, "Tab4_Scatterplot_Select_X_Variable",
                                 choices = vchoicesASS, selected = "None Selected", server = TRUE)
            updateSelectizeInput(session, "Tab4_Scatterplot_Select_Y_Variable",
                                 choices = vchoicesASS, selected = "None Selected", server = TRUE)
            updateSelectizeInput(session, "Tab4_Scatterplot_Select_Colour_Var",
                                 choices = vchoicesASS, selected = "None Selected", server = TRUE)
        })
            ...
            if (is.null(datalist[[data]]()) |
                ...
                metaExpr({
                    ggplot(..(datalist[[data]]())) +
                        geom_point(aes(x = ..(datalist[[data]]())[, ..(input$Tab4_Scatterplot_Select_X_Variable)],
                        ...
                        scale_colour_discrete(..(input$Tab4_Scatterplot_Legend_Title),
...
Tab4_Barplot_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
        ...
        observe({
            vchoicesASS <- c(names(datalist[[data]]()), "None Selected")
            updateSelectizeInput(session, "Tab4_Barplot_Select_X_Variable",
                                 choices = vchoicesASS, selected = "None Selected", server = TRUE)
            updateSelectizeInput(session, "Tab4_Barplot_Select_Y_Variable",
                                 choices = vchoicesASS, selected = "None Selected", server = TRUE)
        })
        ...
        barplot <- metaReactive2({
            if (is.null(datalist[[data]]()) |
                ...
                metaExpr({
                    ggplot(..(datalist[[data]]()),
                           aes(x = factor(..(datalist[[data]]())[, ..(input$Tab4_Barplot_Select_X_Variable)]),
                               fill = factor(..(datalist[[data]]())[, ..(input$Tab4_Barplot_Select_Y_Variable)]))) +
...
Tab4_Hist_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
        ...
        observe({
            ...
            updateSelectizeInput(session, "Tab4_Select_Plot_Variable",
                                 choices = vchoicesDist,
                                 selected = "None Selected",
                                 server = TRUE)
            updateSelectizeInput(session, "Tab4_Both_Plot_Select_Facet_Variable",
                                 choices = vchoicesDist,
                                 selected = "None Selected",
                                 server = TRUE)
            updateSelectizeInput(session, "Tab4_Histogram_Select_Facet_Variable",
                                 choices = vchoicesDist,
                                 selected = "None Selected",
                                 server = TRUE)
        })
        ...
        observe({
            vchoicesASS <- c(names(datalist[[data]]()), "None Selected")
            updateSelectizeInput(session, "Tab4_Density_Plot_Select_Fill_Variable",
                                 choices = vchoicesASS,
                                 selected = "None Selected",
                                 server = TRUE)
            updateSelectizeInput(session, "Tab4_Both_Plot_Select_Fill_Variable",
                                 choices = vchoicesASS,
                                 selected = "None Selected",
                                 server = TRUE)
            updateSelectizeInput(session, "Tab4_Histogram_Select_Fill_Variable",
                                 choices = vchoicesASS,
                                 selected = "None Selected",
                                 server = TRUE)
        })
        ...
        CNAHistogram <- metaReactive2({
            if (is.null(datalist[[data]]()) | input$Tab4_Select_Plot_Variable == "None Selected") {
                ...
                metaExpr({
                    ggplot(..(datalist[[data]]()), aes(..(datalist[[data]]())[,..(input$Tab4_Select_Plot_Variable)])) +
                        geom_histogram(aes(color = 'Color', fill = "Color"),
                                       show.legend = FALSE,
                ...
                if (input$Tab4_Histogram_Display_NAs == FALSE) {
                    metaExpr({
                        Data <- completeFun(..(datalist[[data]]()), c(..(input$Tab4_Histogram_Select_Fill_Variable)))
                        ggplot(Data, aes(Data[, ..(input$Tab4_Select_Plot_Variable)])) +
                            geom_histogram(aes(fill = Data[, ..(input$Tab4_Histogram_Select_Fill_Variable)],
                            ...
                            theme(strip.text = element_text(size = 15)) +
                            theme(legend.text = element_text(size = 15)) +
                            theme(legend.position = ..(input$Tab4_Histogram_Legend_Position)) +
                    ...
                    metaExpr({
                        ggplot(..(datalist[[data]]()), aes(..(datalist[[data]]())[,..(input$Tab4_Select_Plot_Variable)])) +
                            geom_histogram(aes(fill = ..(datalist[[data]]())[,..(input$Tab4_Histogram_Select_Fill_Variable)],
        ...
        long_fileHist <- metaReactive2({
            if (input$Tab4_Faceted_Histogram_Display_NAs == FALSE) {
                metaExpr({
                    reshape2::melt(..(datalist[[data]]())[, c(..(input$Tab4_Select_Plot_Variable),
                                                              ..(input$Tab4_Histogram_Select_Facet_Variable))]) %>%
                        filter(!is.na(eval(parse(text = ..(input$Tab4_Histogram_Select_Facet_Variable)))))
                })
            } else {
                metaExpr({
                    reshape2::melt(..(datalist[[data]]())[, c(..(input$Tab4_Select_Plot_Variable),
        ...
        CNAHisttab <- metaReactive2({
            if (is.null(datalist[[data]]()) | input$Tab4_Histogram_Select_Facet_Variable == "None Selected") {
                ggplot() + theme_void()
            } else {
                metaExpr({
                    ggplot(..(long_fileHist()), aes(x=value)) +
                        geom_histogram(aes(color = factor(..(long_fileHist())[,..(input$Tab4_Histogram_Select_Facet_Variable)]),
                                           fill=factor(..(long_fileHist())[,..(input$Tab4_Histogram_Select_Facet_Variable)])),
                                       alpha = ..(input$Tab4_Faceted_Histogram_Alpha),
                                       binwidth = ..(input$Tab4_Faceted_Histogram_Number_of_Bins)) +
                        facet_wrap(factor(..(long_fileHist())[,..(input$Tab4_Histogram_Select_Facet_Variable)])~.,
                                   ncol=..(input$Tab4_Faceted_Histogram_Number_of_Columns)) +
                        ggtitle(..(input$Tab4_Faceted_Histogram_Title)) +
                        ylab(..(input$Tab4_Faceted_Histogram_Y_Axis_Title)) +
                        xlab(..(input$Tab4_Faceted_Histogram_X_Axis_Title)) +
                        theme_bw() +
                        theme(plot.title = element_text(hjust = 0.5, size =18)) +
                        theme(axis.title.x = element_text(hjust = 0.5, size=18)) +
                        theme(axis.title.y = element_text(hjust = 0.5, size=18)) +
                        ...
                        theme(strip.text = element_text(size=15)) +
                        theme(legend.text=element_text(size=15)) +
                        theme(legend.position = ..(input$Tab4_Faceted_Histogram_Legend_Position)) +
                        scale_fill_discrete(..(input$Tab4_Faceted_Histogram_Legend_Title)) +
                        guides(color = FALSE)
                })
            }
        })
        ...
        output$Tab4_Download_Histogram_PNG <- downloadHandler(
            ...
            content = function(file){
                png(file, width = input$Tab4_Histogram_Width,
        ...
        output$Tab4_Download_Histogram_SVG <- downloadHandler(
            filename = function(){paste("Histogram",'.svg',sep='')},
            content = function(file){
                svg(file, width = input$Tab4_Histogram_Width,
                    height = input$Tab4_Histogram_Height)
                print(CNAHistogram())
                dev.off()
            }
        ...
        output$Tab4_Download_Faceted_Histogram_PNG <- downloadHandler(
            filename = function(){paste("Histogram_Facet",'.png',sep='')},
            content = function(file){
                png(file, width = input$Tab4_Faceted_Histogram_Width,
        ...
        output$Tab4_Download_Faceted_Histogram_SVG <- downloadHandler(
            filename = function(){paste("Histogram_Facet",'.svg',sep='')},
            content = function(file){
                svg(file, width = input$Tab4_Faceted_Histogram_Width,
                    height = input$Tab4_Faceted_Histogram_Height)
                print(CNAHisttab())
                dev.off()
            }
        ...
        CNADense <- metaReactive2({
            if (is.null(datalist[[data]]()) |
                ...
                metaExpr({
                    ggplot(..(datalist[[data]]())) +
                        geom_density(
                            aes(x=..(datalist[[data]]())[,..(input$Tab4_Select_Plot_Variable)],
                ...
                metaExpr({
                    if (input$Tab4_Density_Plot_Display_NAs == FALSE) {
                        ...
                        ggplot(Data) +
                            geom_density(
                                aes(x=Data[,..(input$Tab4_Select_Plot_Variable)],
        ...
        output$Tab4_Download_Density_Plot_PNG <- downloadHandler(
            filename = function(){paste("Density_Plot",'.png',sep='')},
            content = function(file){
                png(
                    file,
        ...
        output$Tab4_Download_Density_Plot_SVG <- downloadHandler(
            filename = function(){paste("Density_Plot",'.svg',sep='')},
            content = function(file){
                svg(
                    file,
                    width = input$Tab4_Density_Plot_Width,
        ...
        CNADist1Plot <- metaReactive2({
            if(is.null(datalist[[data]]()) | input$Tab4_Select_Plot_Variable == "None Selected") {
                ...
                metaExpr({
                    ...
                    dt <- data.frame(x = c(1:length(..(datalist[[data]]())[, ..(input$Tab4_Select_Plot_Variable)])),
                    ...
                    ggplot(df, aes(x, y)) +
                        ...
                        xlab(..(input$Tab4_Segmented_Density_Plot_X_Axis_Title)) +
                        ylab(..(input$Tab4_Segmented_Density_Plot_Y_Axis_Title)) +
                        ggtitle(..(input$Tab4_Segmented_Density_Plot_Title)) +
                        theme_bw() +
                ...
                metaExpr({
                    ...
                    ggplot(df, aes(x, y)) +
                        ...
                        theme(legend.position = c(0.9, 0.5)) +
                        theme(legend.key.size = unit(0.9, "cm")) +
                        scale_fill_manual(values = getPalette(colourCount), name = ..(input$Tab4_Segmented_Density_Plot_Legend_Title)) +
                        guides(fill = FALSE)
                })
            }
        })
        ...
        output$Tab4_Download_Segmented_Density_Plot_PNG <- downloadHandler(
            filename = function() {
        ...
        output$Tab4_Download_Segmented_Density_Plot_SVG <- downloadHandler(
            filename = function() {
            ...
            if (input$Tab4_Faceted_Density_Plot_Display_NAs == FALSE) {
                metaExpr({
                    reshape2::melt(..(datalist[[data]]())[,c(..(input$Tab4_Select_Plot_Variable),
                        ...
                        filter(!is.na(eval(parse(text = ..(input$Tab4_Density_Plot_Select_Facet_Variable)))))
                })
            } else {
                metaExpr({
                    reshape2::melt(..(datalist[[data]]())[,c(..(input$Tab4_Select_Plot_Variable),
                ...
                metaExpr({
                    ggplot(..(long_file())) +
                        ...
                        facet_wrap(
                            ...
                            ncol = ..(input$Tab4_Faceted_Density_Plot_Number_of_Columns)
                        ) +
                        ggtitle(..(input$Tab4_Faceted_Density_Plot_Title)) +
                        ylab(..(input$Tab4_Faceted_Density_Plot_Y_Axis_Title)) +
                        xlab(..(input$Tab4_Faceted_Density_Plot_X_Axis_Title)) +
                        theme_bw() +
                        theme(
                            ...
                            strip.text = element_text(size = 15),
                            legend.text = element_text(size = 15),
                            legend.position = ..(input$Tab4_Faceted_Density_Plot_Legend_Position)
                        ) +
                        scale_fill_discrete(
                            name = ..(input$Tab4_Faceted_Density_Plot_Legend_Title)
                        ) +
                        xlim(range(
                            density(
        ...
        output$Tab4_Download_Faceted_Density_Plot_PNG <- downloadHandler(
            filename = function() {
        ...
        output$Tab4_Download_Faceted_Density_Plot_SVG <- downloadHandler(
            filename = function() {
            ...
            if (is.null(datalist[[data]]()) | input$Tab4_Select_Plot_Variable == "None Selected") {
                ...
                metaExpr({
                    ggplot(..(datalist[[data]]())) +
                        ...
                        geom_histogram(
                            aes(x = ..(datalist[[data]]())[, ..(input$Tab4_Select_Plot_Variable)],
                                y = ..density.., color = "Color", fill = "Color"),
                            alpha = ..(input$Tab4_Both_Histogram_Alpha),
                            fill = "#2ac0db", position = "identity"
                        ) +
        ...
        output$Tab4_Download_Both_Plot_PNG <- downloadHandler(
            filename = function() { paste("Density_Hist_Plot", '.png', sep = '') },
            content = function(file) {
                png(
                    file,
        ...
        output$Tab4_Download_Both_Plot_SVG <- downloadHandler(
            filename = function() { paste("Density_Hist_Plot", '.svg', sep = '') },
            content = function(file) {
                svg(
                    file,
                    width = input$Tab4_Both_Plot_Width,
            ...
            if (input$Tab4_Faceted_Both_Plot_Display_NAs == FALSE) {
                metaExpr({
                    reshape2::melt(..(datalist[[data]]())[, c(
                        ...
                        filter(!is.na(eval(parse(text = ..(input$Tab4_Both_Plot_Select_Facet_Variable)))))
                })
            } else {
                metaExpr({
                    reshape2::melt(..(datalist[[data]]())[, c(
                ...
                metaExpr({
                    ggplot(..(long_file1()), aes(x=value)) +
                        geom_histogram(aes(x=value, y=..density..,
                                       ...
                                       position = "identity",
                                       alpha = ..(input$Tab4_Faceted_Both_Histogram_Plot_Alpha)) +
                        geom_density(aes(x=value,
                                         color = factor(..(long_file1())[,..(input$Tab4_Both_Plot_Select_Facet_Variable)]),
                                         fill=factor(..(long_file1())[,..(input$Tab4_Both_Plot_Select_Facet_Variable)])),
                                     show.legend = ..(input$Tab4_Faceted_Both_Plot_Legend_Position),
                                     alpha= ..(input$Tab4_Faceted_Both_Density_Plot_Alpha)) +
                        facet_wrap(factor(..(long_file1())[,..(input$Tab4_Both_Plot_Select_Facet_Variable)])~.,
                                   ncol=..(input$Tab4_Faceted_Both_Plot_Number_of_Columns)) +
                        ggtitle(..(input$Tab4_Faceted_Both_Plot_Title)) +
                        ylab(..(input$Tab4_Faceted_Both_Plot_Y_Axis_Title)) +
                        xlab(..(input$Tab4_Faceted_Both_Plot_X_Axis_Title)) +
                        theme_bw() +
                        theme(plot.title = element_text(hjust = 0.5, size =18)) +
                        theme(axis.title.x = element_text(hjust = 0.5, size=18)) +
                        theme(axis.title.y = element_text(hjust = 0.5, size=18)) +
        ...
        # download plots
        output$Tab4_Download_Faceted_Both_Plot_PNG <- downloadHandler(
            filename = function() {
                paste("Faceted_Density_Plot2", '.png', sep='')
            },
            content = function(file) {
                png(file, width = input$Tab4_Faceted_Both_Plot_Width,
                    height = input$Tab4_Faceted_Both_Plot_Height, units = "in", res = 1200)
                print(CNADist2Plot1())
                dev.off()
            }
        )

        output$Tab4_Download_Faceted_Both_Plot_SVG <- downloadHandler(
            filename = function() {
                paste("Faceted_Density_Plot2", '.svg', sep='')
            },
            content = function(file) {
                svg(file, width = input$Tab4_Faceted_Both_Plot_Width,
