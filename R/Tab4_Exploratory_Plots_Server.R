...
Tab4_BoxPlots_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
        observe({vchoicesbox1 <- c(names(datalist[[data]]()), "None Selected")
       ...
       boxplot <- metaReactive2({
            if(is.null(datalist[[data]]()) | input$Tab4_Boxplot_Select_X_Variable == "None Selected" | input$Tab4_Boxplot_Select_Y_Variable == "None Selected"){
                ggplot() + theme_void()
            } else {
                metaExpr({ggplot(data = ..(datalist[[data]]()), mapping = aes(x = ..(datalist[[data]]())[,..(input$Tab4_Boxplot_Select_X_Variable)], y = ..(datalist[[data]]())[,..(input$Tab4_Boxplot_Select_Y_Variable)], color = ..(datalist[[data]]())[,..(input$Tab4_Boxplot_Select_X_Variable)])) +
                        geom_boxplot(varwidth = ..(input$Tab4_Boxplot_by_Sample_Size), na.rm = TRUE, aes(fill = ..(datalist[[data]]())[,..(input$Tab4_Boxplot_Select_X_Variable)]), alpha = 0.35) + geom_jitter(alpha = 0.3) + ggtitle(..(input$Tab4_Boxplot_Title)) +
                        ylab(..(input$Tab4_Boxplot_Y_Axis_Title)) + xlab(..(input$Tab4_Boxplot_X_Axis_Title)) + theme_bw() +
                        theme(plot.title = element_text(hjust = 0.5, size =18), axis.title.x = element_text(hjust = 0.5, size=18), axis.title.y = element_text(hjust = 0.5, size=18),
                              axis.text.x=element_text(size=15), axis.text.y=element_text(size=15), legend.title = element_text(colour="black", size=15, face="bold"), strip.text = element_text(size=15), legend.text=element_text(size=15)) +
...
Tab4_Scatterplot_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
        observe({vchoicesASS  <-  c(names(datalist[[data]]()), "None Selected")
        ...
        scatterplot <- metaReactive2({
            if(is.null(datalist[[data]]()) | input$Tab4_Scatterplot_Select_X_Variable == "None Selected" | input$Tab4_Scatterplot_Select_Y_Variable == "None Selected"){
                ggplot() + theme_void()
                ...
                metaExpr({ggplot(..(datalist[[data]]())) + geom_point(aes(x=..(datalist[[data]]())[,..(input$Tab4_Scatterplot_Select_X_Variable)], y=..(datalist[[data]]())[,..(input$Tab4_Scatterplot_Select_Y_Variable)]), size = 1.5) +
                        ggtitle(..(input$Tab4_Scatterplot_Title)) + ylab(..(input$Tab4_Scatterplot_Y_Axis_Title)) + xlab(..(input$Tab4_Scatterplot_X_Axis_Title)) + theme_bw() +  theme(plot.title = element_text(hjust = 0.5, size =18)) + theme(axis.title.x = element_text(hjust = 0.5, size=18)) + theme(axis.title.y = element_text(hjust = 0.5, size=18)) +
                ...
                metaExpr({ggplot(..(datalist[[data]]())) + geom_point(aes(x=..(datalist[[data]]())[,..(input$Tab4_Scatterplot_Select_X_Variable)], y=..(datalist[[data]]())[,..(input$Tab4_Scatterplot_Select_Y_Variable)], colour = ..(datalist[[data]]())[,..(input$Tab4_Scatterplot_Select_Colour_Var)]), size = 1.5) +
                        ggtitle(..(input$Tab4_Scatterplot_Title)) + ylab(..(input$Tab4_Scatterplot_Y_Axis_Title)) + xlab(..(input$Tab4_Scatterplot_X_Axis_Title)) + theme_bw() + theme(plot.title = element_text(hjust = 0.5, size =18)) + theme(axis.title.x = element_text(hjust = 0.5, size=18)) + theme(axis.title.y = element_text(hjust = 0.5, size=18)) +
                        theme(axis.text.x=element_text(size=15)) +  theme(axis.text.y=element_text(size=15)) + theme(legend.title = element_text(colour="black", size=15, face="bold")) + theme(strip.text = element_text(size=15)) + theme(legend.text=element_text(size=15)) +
                        scale_colour_discrete(..(input$Tab4_Scatterplot_Legend_Title), na.translate = ..(input$Tab4_Scatterplot_Display_NAs)) + theme(legend.position = ..(input$Tab4_Scatterplot_Legend_Position))}) }})
...
Tab4_Barplot_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
        ...
        barplot <- metaReactive2({
            if(is.null(datalist[[data]]()) | input$Tab4_Barplot_Select_X_Variable == "None Selected" | input$Tab4_Barplot_Select_Y_Variable == "None Selected"){
                ggplot() + theme_void() }
            else{metaExpr({ggplot(..(datalist[[data]]()), aes(x=factor(..(datalist[[data]]())[,..(input$Tab4_Barplot_Select_X_Variable)]), fill=factor(..(datalist[[data]]())[,..(input$Tab4_Barplot_Select_Y_Variable)]))) + geom_bar(position="fill") +
                    ggtitle(..(input$Tab4_Barplot_Title)) + ylab(..(input$Tab4_Barplot_Y_Axis_Title)) + xlab(..(input$Tab4_Barplot_X_Axis_Title))  + theme_bw() + theme(plot.title = element_text(hjust = 0.5, size =18)) + theme(axis.title.x = element_text(hjust = 0.5, size=18)) + theme(axis.title.y = element_text(hjust = 0.5, size=18)) +
                    theme(axis.text.x=element_text(size=15)) +  theme(axis.text.y=element_text(size=15)) + theme(legend.title = element_text(colour="black", size=15, face="bold")) + theme(strip.text = element_text(size=15)) + theme(legend.text=element_text(size=15)) +
...
Tab4_Hist_Server <- function(id, datalist, data) {
    moduleServer(id, function(input, output, session) {
    observe({vchoicesDist <-  c(names(datalist[[data]]()), "None Selected")
    ...
    CNAHistogram <-  metaReactive2({
        if(is.null(datalist[[data]]()) | input$Tab4_Select_Plot_Variable  == "None Selected"){
            ...
            metaExpr({ggplot(..(datalist[[data]]()), aes(..(datalist[[data]]())[,..(input$Tab4_Select_Plot_Variable)])) + geom_histogram(aes(color = 'Color', fill= "Color"), show.legend = FALSE, binwidth = ..(input$Tab4_Histogram_Number_of_Bins), alpha = ..(input$Tab4_Histogram_Alpha)) +
            ...
            if(input$Tab4_Histogram_Display_NAs == FALSE){metaExpr({ Data <- completeFun(..(datalist[[data]]()), c(..(input$Tab4_Histogram_Select_Fill_Variable)))
            ...
            } else {metaExpr({ggplot(..(datalist[[data]]()), aes(..(datalist[[data]]())[,..(input$Tab4_Select_Plot_Variable)])) + geom_histogram(aes(fill = ..(datalist[[data]]())[,..(input$Tab4_Histogram_Select_Fill_Variable)], color = ..(datalist[[data]]())[,..(input$Tab4_Histogram_Select_Fill_Variable)]), binwidth = ..(input$Tab4_Histogram_Number_of_Bins), alpha = ..(input$Tab4_Histogram_Alpha)) +
                    ggtitle(..(input$Tab4_Histogram_Title)) + ylab(..(input$Tab4_Histogram_Y_Axis_Title)) + xlab(..(input$Tab4_Histogram_X_Axis_Title)) + theme_bw() + theme(plot.title = element_text(hjust = 0.5, size =18)) + theme(axis.title.x = element_text(hjust = 0.5, size=18)) + theme(axis.title.y = element_text(hjust = 0.5, size=18)) +
    ...
    long_fileHist <- metaReactive2({if(input$Tab4_Faceted_Histogram_Display_NAs == FALSE){
        metaExpr({melt(..(datalist[[data]]())[,c(..(input$Tab4_Select_Plot_Variable), ..(input$Tab4_Histogram_Select_Facet_Variable))]) %>% filter(!is.na(eval(parse(text = ..(input$Tab4_Histogram_Select_Facet_Variable))))) })
    } else {
        metaExpr({melt(..(datalist[[data]]())[,c(..(input$Tab4_Select_Plot_Variable), ..(input$Tab4_Histogram_Select_Facet_Variable))])})}})
    ...
    CNAHisttab <- metaReactive2({
        if(is.null(datalist[[data]]()) | input$Tab4_Histogram_Select_Facet_Variable  == "None Selected"){
            ggplot() + theme_void()
                ...
                ylab(..(input$Tab4_Faceted_Histogram_Y_Axis_Title)) + xlab(..(input$Tab4_Faceted_Histogram_X_Axis_Title)) + theme_bw() + theme(plot.title = element_text(hjust = 0.5, size =18)) + theme(axis.title.x = element_text(hjust = 0.5, size=18)) + theme(axis.title.y = element_text(hjust = 0.5, size=18)) +
